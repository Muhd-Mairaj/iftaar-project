...
export default function PublicDonationPage() {
  ...
  return (
    <div className="flex-grow flex flex-col items-center justify-center relative z-10 overflow-hidden min-h-[60vh]">
      <div className="w-full max-w-sm mx-auto space-y-4">
        ...
        <div className="relative bg-card/30 backdrop-blur-3xl border dark:border-white/5 rounded-[2.5rem] p-4 shadow-2xl shadow-black/5 overflow-hidden group">
