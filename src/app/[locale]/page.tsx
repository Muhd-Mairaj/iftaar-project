...
export default function PublicDonationPage() {
  ...
  return (
    <div className="flex-grow flex flex-col items-center justify-center p-4 h-full relative z-10 overflow-hidden">
      <div className="w-full max-w-sm mx-auto space-y-4">
        <header className="text-center space-y-2 animate-in fade-in duration-500">
        ...
        <div className="relative bg-card/30 backdrop-blur-3xl border border-white/20 dark:border-white/5 rounded-[2.5rem] p-4 shadow-2xl overflow-hidden group">
